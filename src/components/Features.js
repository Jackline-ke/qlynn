...
const Features = () => {
  return (
    <div id="features" className='w-full h-screen text-[#4d3319] font-serif flex flex-col justify-center items-center px-8 md:px-48'>
        <h3 className='mb-8 text-4xl'>My <span className='font-bold'>Expertise</span></h3>
        <div className='flex flex-col sm:flex-row gap-8'>
            <div className='border py-4 px-4 md:px-8 md:py-8 flex flex-col gap-2 items-center'>
