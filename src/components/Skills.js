...
const Skills = () => {
  ...
  return (
    <div data-aos="fade-right" id="skills" className='py-24 lg:py-0 w-full h-screen bg-[#f9f2ec] text-[#4d3319] font-serif flex flex-col justify-center items-center px-8 md:px-16'>
