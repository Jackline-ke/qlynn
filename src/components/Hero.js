    ...
    <div id='home' className='w-full h-screen bg-[#f9f2ec] text-[#4d3319] font-serif flex justify-center items-center px-4'>
        <div className='text-center py-8'>
            ...
            <div className='flex gap-4 justify-center mt-5'>
              <a href='https://github.com/Jackline-ke'><FaGithub size={25} className='cursor-pointer'/></a>
              <a href='https://www.linkedin.com/in/jackline-adhiambo-5049631a7/'><FaLinkedin size={20} className='cursor-pointer'/></a>
              <a href='https://twitter.com/JacklineOdhia19'><FaTwitter size={25} className='cursor-pointer'/></a>
              <a href='https://medium.com/@antoninahodhiambo'><FaMedium size={25} className='cursor-pointer'/></a>
            </div>
        </div>
